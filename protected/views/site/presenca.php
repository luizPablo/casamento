...
<body class="no-slider-page">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-3"></div>
                            <div class="col-md-6">
                                <a id="cp" style="width: 100%!important; text-align: center;" class="de-button small reverse">
                                    <span>CONFIRMAR</span>
                                </a>
                            </div>
                            <div class="col-md-3"></div>
                        </div>
                        <div class="row confirmacao text-center" style="display: none;">
                            <div class="col-md-3"></div>
                            <div class="col-md-6">
                                <h2>Sua presença foi confirmada! Obrigado por estar presente neste momento tao especial para nos</h2>
                            </div>
                            <div class="col-md-3"></div>
                        </div>
                    </div>
    ...
    <!-- FOOTER SECTION -->
    <footer>
        <div class="image-divider fixed-height" style="background-image:url(/images/lp/10.jpeg); height:400px" data-stellar-background-ratio="0.5" >
