...
<body class="slider-title-page">
    <audio autoplay="true" loop="true" src="/music/aom.mp3"></audio>
    <!--PRELOADER-->
    <div id="preloader">
    ...
    <section id="main-slider" class="fixed-height">      	
                        ...
                        <div class="row">
                            <div class="col-md-offset-3 col-md-6">                                     
                                ...
                                <div class="page-title">
                                    <h1 class="animation bounceInLeft">LORRANA FORTALEZA</h1>
                                    ...
                                    <p class="animation delay1 bounceInRight">
                                        "De tantas bençãos que eu já tive nessa vida, você foi a melhor de todas, pois foi através de você que Deus me concedeu todas as outras" (Luiz Pablo) 
                                    </p>
                                </div>
        ...
        <div class="slides">
            <!-- SLIDE IMAGE -->
            <div data-stellar-ratio="0.5" class="slide-image" style="background-image:url(/images/lp/9.jpeg);">
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 text-center" style="padding-bottom:50px;">
                    ...
                    <a href="http://facebook.com/lorrana.fortaleza" target="_blank">
                        <div class="de-icon circle outline medium-size inline">
                            <i class="de-icon-facebook"></i>
                        </div>
                    </a>

                    <a href="http://instagram.com/lorrana_fortaleza" target="_blank">
                        <div class="de-icon circle outline medium-size inline">
            ...
            <div class="row">
                <div class="col-md-offset-1 col-md-5">
                    <p>
                        <strong>Por Luiz: </strong>Quem conhece Lorrana, sabe que, depois de sua beleza, a característica mais marcante nela é a sua personalidade forte, e logo em seguida o seu dom de ajudar as pessoas, qualquer um que esteja precisando e esteja ao alcance dela fazer algo.
                    </p>
                    <p>
                        Lorrana é de longe, uma das pessoas que mais admiro nessa vida, não apenas por seu bom coração, ou por ter uma base tão sólida de princípios, ou por sua perseverança, ou por sua imensa fé, é principalmente pela sua força. Ela consegue, sozinha, carregar grandes cargas emocionais e lida com isso de uma forma incrível, eu tenho muito o que aprender com ela nesse sentido.
                    </p>                            
                </div>
                <div class="col-md-5">
                    <p>
                        A família para ela é algo de valor inestimável, está sempre disposta a auxiliar os seus, seja lá como for, a ideia de ficar longe de sua família, para ela, é aterrorizante. Se possível fosse, certamente colocaria todos em uma bolsa e levaria junto com ela por onde fosse.
                    </p>
                    <p>
                        Terei o privilégio de conviver com essa moça pelo resto da minha vida, agradeço a Deus pela sua vida, e por Ele ter colocado esse anjo em meu caminho, que veio para me mudar completamente, para me fazer provar, verdadeiramente, desse sentimento tão grande chamado amor. A minha missão é só uma, aquela que eu tantas vezes já te falei: te fazer feliz, em qualquer circunstância.
                    </p>                            
                </div>
