...
<body class="no-slider-page">
        ...
        <div class="container">            
            ...
            <section id="heading">
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <a style="width: 100%!important;"  class="de-button small">
                                    Valor: R$ <?php echo $p->valor ?>
                                </a>
                            </div>
                            <div class="col-md-2">
                                <a style="width: 100%!important;" class="de-button small">
                                    Temos: R$ <?php echo $p->acumulado ?>
                                </a>
                            </div>
                            <div class="col-md-2">
                                <a style="width: 100%!important;"  class="de-button small">
                                    Faltam: R$ <?php echo $p->valor - $p->acumulado ?>
                                </a>
                            </div>
                            <div class="col-md-6">
                                ...
                                <?php } else { ?>
                                <a style="width: 100%!important;" class="de-button small">
                                    <i class="de-icon-ok-2"></i> Este já foi, obrigado!
                                </a>  
                                <?php } ?>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12" style="display: none;" id="confirmar_valor">
    ...
    <!-- FOOTER SECTION -->
    <footer>
        <div class="image-divider fixed-height" style="background-image:url(/images/lp/3.jpeg); height:400px" data-stellar-background-ratio="0.5" >
